...
Rails.application.routes.draw do
  ...
  get '/', to: 'application#root', as: 'version_check'
  ...
  post '/matchmaking/queue', to: 'matchmaking#queue', as: 'join_queue'
  ...
  post '/autologin', to: 'users#auto_login', as: 'user_auto_login'
end
