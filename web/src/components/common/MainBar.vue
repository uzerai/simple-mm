<template>
  <div class="flex w-full h-16 bg-black" id="main-bar">
    <div
      class="text-gray-100 flex items-center ml-4 text-xl italic font-bold select-none gap-4"
    >
      <p>SIMPLE-MM</p>
      <div class="h-1/2 border-r border-white"></div>
    </div>
    ...
    <router-link
      to="/login"
      v-if="!this.$store.getters['auth/token']"
